...
from .views import (
    ...
    PuzzleUpdateDeleteView, MarkWordFoundView, MarkDoneView,
    ResetProgressView, MyProgressListView,
)
from .page_views import (
    WordSearchListPageView, WordSearchPlayPageView, WordSearchCreatePageView,
)

# HTML page routes — підключати в головному urls.py
page_urlpatterns = [
...
urlpatterns = [
    ...
    path("<int:pk>/reset/",           ResetProgressView.as_view(),        name="reset-progress"),
]